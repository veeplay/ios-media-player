...
extern NSString *_Nonnull const kAPSVASTPrerollUnit;
extern NSString *_Nonnull const kAPSVASTMidrollUnit;
extern NSString *_Nonnull const kAPSVASTPostrollUnit;
extern NSString *_Nonnull const kAPSVASTNonlinearAd;
...
- (NSArray<APSVASTAdBreak*>* _Nullable)adBreaksForVMAP;
/**-----------------------------------------------------------------------------
